...
export default function Chatbot() {
  ...
  const questions = [
    {
      key: "Welcome message",
      label: "Hi Welcome to StudyNotion!!. Let me introduce myself I'm your chat assistant. How may I help you today?",
    },
    {
      key: "name",
...
//   };
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Save to database
    const res = await fetch(`${process.env.REACT_APP_BASE_URL}/chatbot`, {
  method: "POST",
  headers: {
              ...
              setTyping(false);
                    ...
                    if (res.ok) {
                             setSubmitted(true);
                              ...
                              setValidationError(result.message || "Submission failed");
                                    }
